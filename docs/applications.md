...
- operator drills around peer identity, peer admission, delayed peer recovery, partial quorum, reproposal, per-height round history, rejection diagnostics, and state catch-up
