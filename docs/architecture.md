...
- derived readiness through `GET /v1/health`, including settlement queue-drain checks when automatic block production is enabled and peak drain-forecast detail from recent throughput windows
