			...
			Rules: []AlertRule{
				...
				disableAlertRule(
					newAlertRule(
						...
						"zephyr_peer_sync_reason_occurrence_count{reason=\"peer_diverged\"} > 0",
						"5m",
				...
				disableAlertRule(
					newAlertRule(
						...
						"zephyr_peer_sync_reason_occurrence_count{reason=\"fetch_fallback\"} > 0",
						"5m",
						[]string{"zephyr_peer_sync_reason_occurrence_count"},
						[]string{"peer_snapshot_restored"},
						[]string{"peer_sync_continuity"},
				...
				disableAlertRule(
					newAlertRule(
						...
						"zephyr_peer_sync_reason_occurrence_count{reason=\"import_repair\"} > 0",
						"5m",
						[]string{"zephyr_peer_sync_reason_occurrence_count"},
						[]string{"peer_snapshot_restored"},
						[]string{"peer_sync_continuity"},
