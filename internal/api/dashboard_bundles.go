	...
	return []Dashboard{
		{
			...
			Panels: []DashboardPanel{
				...
				newDashboardPanel(
					...
					nil,
					nil,
					[]string{"node_readiness", "consensus_continuity", "peer_sync_continuity"},
				),
			},
		},
		{
		...
		disableDashboard(Dashboard{
			...
			Panels: []DashboardPanel{
				...
				newDashboardPanel(
					...
					"Summarizes whether recent trouble is dominated by unreachable peers, unadmitted peers, import failures, or snapshot restores.",
					"none",
				...
				newDashboardPanel(
					...
					"Separates transport failures from import-blocked consensus errors so repair churn is easier to diagnose from the dashboard bundle alone.",
					"none",
