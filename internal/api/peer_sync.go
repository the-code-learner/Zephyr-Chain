...
type PeerView struct {
	...
	LastReplicationErrorCode        string                    `json:"lastReplicationErrorCode,omitempty"`
	LastReplicationErrorMessage     string                    `json:"lastReplicationErrorMessage,omitempty"`
	LastReplicationFailureAt        *time.Time                `json:"lastReplicationFailureAt,omitempty"`
	LastReplicationFailureHeight    uint64                    `json:"lastReplicationFailureHeight,omitempty"`
	LastReplicationFailureBlockHash string                    `json:"lastReplicationFailureBlockHash,omitempty"`
	LastReplicationFailureReason    string                    `json:"lastReplicationFailureReason,omitempty"`
