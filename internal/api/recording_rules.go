			...
			Rules: []RecordingRule{
				...
				disableRecordingRule(
					newRecordingRule(
						...
						"Carries the explicit peak settlement drain estimate into a canonical series so dashboards and fleet summaries can reuse the slowest recent backlog-clear projection without re-aggregating per-window series in PromQL.",
						"zephyr_settlement_estimated_queue_drain_seconds_max",
						[]string{"zephyr_settlement_estimated_queue_drain_seconds_max"},
						[]string{settlementThroughputAlertReduced, settlementThroughputAlertStalled},
						[]string{"settlement_throughput"},
					),
					throughputDisabledReason,
				...
				disableRecordingRule(
					newRecordingRule(
						...
						"Carries the explicit peak settlement drain-pressure gauge into a canonical series so dashboards and fleet summaries can reuse the highest projected queue-drain pressure without re-aggregating per-window series in PromQL.",
						"zephyr_settlement_estimated_queue_drain_warn_utilization_ratio_max",
						[]string{"zephyr_settlement_estimated_queue_drain_warn_utilization_ratio_max"},
						[]string{settlementThroughputAlertReduced},
						[]string{"settlement_throughput"},
					),
					throughputDisabledReason,
			...
			Rules: []RecordingRule{
				...
				disableRecordingRule(
					newRecordingRule(
						...
						"peer_sync",
						"Reusable retained snapshot-restore pressure series for peer repair dashboards.",
				...
				disableRecordingRule(
					newRecordingRule(
						"peer sync snapshot restore pressure by reason",
						"zephyr:peer_sync:snapshot_restore_pressure_by_reason",
						"peer_sync",
						"Reusable retained snapshot-restore pressure split by repair path.",
